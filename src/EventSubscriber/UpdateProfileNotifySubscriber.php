 ...
 *
 */
class UpdateProfileNotifySubscriber implements EventSubscriberInterface
{
    private $mailer;
    //private $sender;
    ...
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            Events::USER_PROFILE_UPDATED => 'onUserProfileUpdated',
        ];
    }

    public function onUserProfileUpdated(GenericEvent $event): void
    {
        /** @var User $user */
        $user = $event->getSubject();
        $subject = 'Mis à jour de votre profil !';
