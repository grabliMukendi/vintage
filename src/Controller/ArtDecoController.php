...
class ArtDecoController extends AbstractController
{
    /**
     * @Route("/rubriques/art/deco/{page<\d+>?1}", name="rubrique_art_deco")
     * Route qui mène vers la page de la rubrique
     */
    public function artDecoAction(SessionInterface $session, $page, PaginatorByFilter $pagination) 
    {
        ...
        return $this->render('rubriques/art_deco.html.twig', 
        [
            'produits' => $pagination->data('rubrique', 'art déco', 'id', 'DESC'), // Affichage de tous les produits
            'page' => $page,
            'pages' => $pagination->pages('rubrique', 'art déco'),
    ...
    public function showArtDecoPriceAction(Request $request, SessionInterface $session, $page, PaginatorByFilter $pagination) 
    {
        ...
        $produits = $pagination->getByPrice($price, 'art déco');
    ...
    public function artDecoPrixCroissantAction(SessionInterface $session, Request $request, $page, PaginatorByFilter $pagination) 
    {
        ...
        $stringSaisie = null;
        $nbSearch = null;
        $minPrice = $pagination->getPrixCroissant('rubrique', 'art déco');
    ...
    public function artDecoPrixDecroissantAction(SessionInterface $session, Request $request, $page, PaginatorByFilter $pagination) 
    {
        ...
        $stringSaisie = null;
        $nbSearch = null;
        $maxPrice = $pagination->getPrixDecroissant('rubrique', 'art déco');
