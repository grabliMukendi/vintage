 ...
 */
final class Version20200107161031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produits DROP INDEX FK_BE2DDF8C139DF194, ADD UNIQUE INDEX UNIQ_BE2DDF8C139DF194 (promotion_id)');
        ...
        $this->addSql('ALTER TABLE promotion ADD nom VARCHAR(100) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE produits_id produits_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE produits DROP INDEX UNIQ_BE2DDF8C139DF194, ADD INDEX FK_BE2DDF8C139DF194 (promotion_id)');
        ...
        $this->addSql('ALTER TABLE produits CHANGE tva_id tva_id INT DEFAULT NULL, CHANGE couleur_id couleur_id INT DEFAULT NULL, CHANGE taille_id taille_id INT DEFAULT NULL, CHANGE promotion_id promotion_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE promotion DROP nom');
